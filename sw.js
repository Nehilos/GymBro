const CACHE_NAME = 'thalys-shell-v0.13';
...
const APP_SHELL = [
  ...
  './css/thalys.css?v=013',
  './js/tailwind-config.js?v=013',
  './js/theme-bootstrap.js?v=013',
  './js/ui-foundation.js?v=013',
  './js/google-auth.js?v=013',
  './js/drive.js?v=013',
  './js/app-core.js?v=013',
  './js/oauth-ui.js?v=013',
  './js/media-tools.js?v=013',
  './js/pwa-register.js?v=013',
  './js/app-enhancements.js?v=013',
