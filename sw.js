const CACHE_NAME = 'thalys-shell-v0.14';
...
const APP_SHELL = [
  ...
  './css/thalys.css?v=014',
  './js/tailwind-config.js?v=014',
  './js/theme-bootstrap.js?v=014',
  './js/local-db.js?v=014',
  './js/ui-foundation.js?v=014',
  './js/google-auth.js?v=014',
  './js/drive.js?v=014',
  './js/app-core.js?v=014',
  './js/oauth-ui.js?v=014',
  './js/media-tools.js?v=014',
  './js/pwa-register.js?v=014',
  './js/app-enhancements.js?v=014',
